...
def create_stocks(watch_remnants, offer_ids):
    """Создает список остатков товаров на основе данных о недостающих запасах и идентификаторов предложений.
    ...
    Аргументы:
        ...
        offer_ids (list): Список идентификаторов предложений (str), для которых нужно создать остатки.
...
def create_prices(watch_remnants, offer_ids):
    ...
    Аргументы:
        ...
        offer_ids (set): Набор строк, представляющих идентификаторы предложений.
...
async def upload_prices(watch_remnants, client_id, seller_token):
    ...
    Эта функция получает идентификаторы предложений, создает список цен для этих предложений
...
def main():
    ...
    загружает идентификаторы предложений и остатки товаров, 
